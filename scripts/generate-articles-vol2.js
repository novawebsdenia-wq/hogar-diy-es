...
El olor a amoniaco (o a purín) significa que hay exceso de humedad o poco oxígeno. Echa un par de puñados de tiras de cartón seco y remueve profundamente el cubo.`
  },
  {
    ...
    description: 'No te quedes con el balcón o terraza gris en invierno. Estas 5 plantas aguantan heladas extremas y florecen en los peores meses.',
    date: '2026-03-27',
    readingTime: 4,
...
['jardin', 'herramientas', 'reformas', 'reparaciones', 'ahorro-energetico'].forEach(cat => {
  if (!fs.existsSync(path.join('./content', cat))) fs.mkdirSync(path.join('./content', cat), { recursive: true });
});
...
console.log('Done mapping volume 2 (13 remaining MDX guides) for Carlos Martín authority scaling.');
