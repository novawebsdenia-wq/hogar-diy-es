        ...
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-12">
          ...
          <article>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`${SITE_URL}/${category}/${slug}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 rounded-full bg-[#1877F2] px-4 py-2 text-sm font-bold text-white transition-opacity hover:opacity-90"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
